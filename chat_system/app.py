...
def get_student(student_id):
    ...
    if barcode_filename and not os.path.exists(barcode_path):
        ...
        generated_barcode = CODE39(student_id, writer=ImageWriter())
...
def update_student_info():
    ...
    # ✅ Validate profile picture (ML or fallback)
    if photo_validator and photo_validator.model:
...
def complete_student_profile():
    ...
    if request.method == 'POST':
        ...
        cursor.execute("UPDATE students SET course = %s WHERE student_id = %s", 
